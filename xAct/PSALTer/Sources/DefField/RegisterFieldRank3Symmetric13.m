...
xAct`PSALTer`Private`DefFiducialField[Rank3Symmetric[-b,-a,-c],Symmetric[{-b,-c}]];
...
Rank3SymmetricToRank3SymmetricSymm=Join[
	MakeRule[{Rank3Symmetric[-a,-c,-b],Evaluate[Rank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@Rank3Symmetric[-a,-c,-b],Evaluate@Dagger[Rank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True]];
SourceRank3SymmetricToSourceRank3SymmetricSymm=Join[
	MakeRule[{SourceRank3Symmetric[-a,-c,-b],Evaluate[SourceRank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@SourceRank3Symmetric[-a,-c,-b],Evaluate@Dagger[SourceRank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True]];
Rank3SymmetricSymmToRank3Symmetric=Join[
	MakeRule[{Rank3SymmetricSymm[-a,-b,-c],Evaluate[(1/2)*(Rank3Symmetric[-a,-c,-b]+Rank3Symmetric[-b,-c,-a])]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@Rank3SymmetricSymm[-a,-b,-c],Evaluate@Dagger[(1/2)*(Rank3Symmetric[-a,-c,-b]+Rank3Symmetric[-b,-c,-a])]},MetricOn->All,ContractMetrics->True]];
SourceRank3SymmetricSymmToSourceRank3Symmetric=Join[
	MakeRule[{SourceRank3SymmetricSymm[-a,-b,-c],Evaluate[(1/2)*(SourceRank3Symmetric[-a,-c,-b]+SourceRank3Symmetric[-b,-c,-a])]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@SourceRank3SymmetricSymm[-a,-b,-c],Evaluate@Dagger[(1/2)*(SourceRank3Symmetric[-a,-c,-b]+SourceRank3Symmetric[-b,-c,-a])]},MetricOn->All,ContractMetrics->True]];
