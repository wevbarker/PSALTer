...
xAct`PSALTer`Private`DefFiducialField[Rank3Symmetric[-a,-b,-c],Symmetric[{-b,-c}]];
...
Rank3SymmetricToRank3SymmetricSymm=Join[
	MakeRule[{Rank3Symmetric[-c,-a,-b],Evaluate[Rank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@Rank3Symmetric[-c,-a,-b],Evaluate@Dagger[Rank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True]];
SourceRank3SymmetricToSourceRank3SymmetricSymm=Join[
	MakeRule[{SourceRank3Symmetric[-c,-a,-b],Evaluate[SourceRank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@SourceRank3Symmetric[-c,-a,-b],Evaluate@Dagger[SourceRank3SymmetricSymm[-a,-b,-c]]},MetricOn->All,ContractMetrics->True]];
Rank3SymmetricSymmToRank3Symmetric=Join[
	MakeRule[{Rank3SymmetricSymm[-a,-b,-c],Evaluate[(1/2)*(Rank3Symmetric[-c,-a,-b]+Rank3Symmetric[-c,-b,-a])]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@Rank3SymmetricSymm[-a,-b,-c],Evaluate@Dagger[(1/2)*(Rank3Symmetric[-c,-a,-b]+Rank3Symmetric[-c,-b,-a])]},MetricOn->All,ContractMetrics->True]];
SourceRank3SymmetricSymmToSourceRank3Symmetric=Join[
	MakeRule[{SourceRank3SymmetricSymm[-a,-b,-c],Evaluate[(1/2)*(SourceRank3Symmetric[-c,-a,-b]+SourceRank3Symmetric[-c,-b,-a])]},MetricOn->All,ContractMetrics->True],
	MakeRule[{Evaluate@Dagger@SourceRank3SymmetricSymm[-a,-b,-c],Evaluate@Dagger[(1/2)*(SourceRank3Symmetric[-c,-a,-b]+SourceRank3Symmetric[-c,-b,-a])]},MetricOn->All,ContractMetrics->True]];
